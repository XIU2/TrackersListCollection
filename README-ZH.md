...
> ——  
> **DHT：** Peer 的进阶，分布式储存用户信息，通过该分布式网络获得用户，然后再从获得的用户处获得更多的用户。缺点是 DHT 需要养（下载热门资源），所以一开始时会很尴尬。  
> ——  
> **Tracker：** 它记录了下载同一个资源的用户，帮助你与其他用户建立连接。  
> ***以上三者各有各的优缺点，正好是互补的，不存在代替，一起用效果最好！***   
