...
你链接的做种上传的用户越多，你的下载速度就越快，而用户通过 **Peer、DHT、Tracker** 获得。  
...
_有兴趣的可以下载 **[ubuntu-20.04.torrent](https://releases.ubuntu.com/20.04/ubuntu-20.04.4-desktop-amd64.iso.torrent)** 试试，该资源全球数千人做种上传，因此大部分人下载速度很快！_
...
> 不过这些 Tracker 不会影响 BT 软件的，软件重试（多线程）几次就会忽略了，所以也不需要在意。
...
> 不仅要关注**用户数量**，还要关注**用户质量**，因为国内绝大部分家庭宽带都没有公网 IP，因此上传速度比较捉急，另一方面也是运营商上传不对等，还老是干扰 BT、限制 UDP 协议，这也是国内BT环境这么差的主要原因之一。  
...
说实话，这个项目起初只是我为了解决我的小需求**自给自足自用**的，没啥技术含量，结果没想到几年过去了，用的人越来越多了，⭐Star 竟然都突破了 10k。。。成为了我所有开源项目中数据最高的项目，属实把我惊到了。。。  
